...
namespace ImportByFunction
{
    public partial class ImportByFunction : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            //                            string TVText = mwqmRun.c.DateTime_Local.ToString("yyyy MM dd");
            //                            if (mwqmRun.c.RunNumber > 1)
            //                            {
            //                                TVText = TVText + " (" + mwqmRun.c.RunNumber.ToString() + ")";
            //                            }
            //                            TVText = TVText + (mwqmRun.c.RunSampleType != (int)SampleTypeEnum.Routine ? " (" + baseEnumService.GetEnumText_SampleTypeEnum((SampleTypeEnum)mwqmRun.c.RunSampleType) + ")" : "");

            //                            if (tvItemLanguage.TVText != TVText)
            //                            {
            ...
            //            using (TempDataToolDBEntities dt = new TempDataToolDBEntities())
            //            {
            //                string Area = tvItem.tl.TVText.Substring(3, 2);
            //                string Sector = tvItem.tl.TVText.Substring(6, 3);
            //                string Subsector = tvItem.tl.TVText.Substring(10, 3);
            //                asgadRunList = (from c in dt.ASGADRuns
            //                                where c.PROV == "PE"
            //                                && c.AREA == Area
            //                                && c.SECTOR == Sector
            ...
            //            if (asgadRunList.Count != mwqmRunList.Count)
            //            {
            //                int sleifsleifj = 34;
            //            }
            ...
            //                foreach (var mwqmRun in mwqmRunList)
            //                {
            //                    ASGADRun asgadRunExist = (from c in asgadRunList
            //                                              where c.SAMP_DATE.Value.Year == mwqmRun.c.DateTime_Local.Year
            //                                              && c.SAMP_DATE.Value.Month == mwqmRun.c.DateTime_Local.Month
            //                                              && c.SAMP_DATE.Value.Day == mwqmRun.c.DateTime_Local.Day
            //                                              && c.RUN_NUMBER == mwqmRun.c.RunNumber
            //                                              select c).FirstOrDefault();
            //                    if (asgadRunExist == null)
            //                    {
            //                        richTextBoxStatus.AppendText(tvItem.tl.TVText + "\t" + mwqmRun.tl.TVText + "\t" + mwqmRun.t.TVItemID + "\t" + mwqmRun.c.RunSampleType + "\t" + mwqmRun.c.RunNumber + "\r\n");

            //                        MWQMRun mwqmRunToDelete = (from c in ddd.MWQMRuns
            //                                                   where c.MWQMRunID == mwqmRun.c.MWQMRunID
            //                                                   select c).FirstOrDefault();

            //                        if (mwqmRunToDelete != null)
            //                        {
            //                            ddd.MWQMRuns.Remove(mwqmRunToDelete);
            //                        }
            //                    }
            //                }
            ...
            //                               && tl.Language == (int)LanguageEnum.en
            //                               //&& t.IsActive == true
            //                               && c.DateTime_Local.Year > 2016
            //                               select new { c, t, tl }).ToList();

            //            foreach (var mwqmRun in mwqmRunList)
            //            {

            //                //if (mwqmSite != null && mwqmSite.c.MWQMSiteLatestClassification == (int)MWQMSiteLatestClassificationEnum.Error)
            //                //{
            //                    richTextBoxStatus.AppendText(tvItem.tl.TVText + "\t" + mwqmRun.t.TVItemID + "\t" + mwqmRun.tl.TVText + "\r\n");
            //                //}
            //            }
            //        }
            //    }
            ...
            //string FileName = @"C:\CSSP Latest Code old\DataTool\ImportByFunction\Data_inputs\PEI Active and Inactive MWQMSite Final.xlsx";
            ...
            //    else
            //    {
            //        IsActive = reader.GetValue(3).ToString().Trim();
            //    }
            ...
            //            int selfij = 34;
            //        }
            //        TVItem tvItemMWQMSite = (from c in dd.TVItems
            //                                 where c.TVItemID == IDint
            ...
            //            {
            //                tvItemMWQMSite.IsActive = false;
            //            }
            //            else
            //            {
            //                tvItemMWQMSite.IsActive = true;
            //            }
            ...
            //                            from tl in dd.TVItemLanguages
            //                            where t.TVItemID == tl.TVItemID
            //                            && t.TVPath.StartsWith(tvItemNS.TVPath)
            //                            && tl.Language == (int)LanguageEnum.en
            //                            && t.TVType == (int)TVTypeEnum.Subsector
            //                            orderby tl.TVText
            //                            select new { t, tl }).ToList();
            ...
            //            var mwqmSiteList = (from t in dd.TVItems
            //                                from tl in dd.TVItemLanguages
            //                                from c in dd.MWQMSites
            //                                where t.TVItemID == tl.TVItemID
            //                                && t.TVItemID == c.MWQMSiteTVItemID
            //                                && t.ParentID == tvItem.t.TVItemID
            ...
            //                if (mwqmSite != null && mwqmSite.c.MWQMSiteLatestClassification == (int)MWQMSiteLatestClassificationEnum.Error)
            //                {
            //                    richTextBoxStatus.AppendText(tvItem.tl.TVText + "\t" + mwqmSite.t.TVItemID + "\t" + mwqmSite.tl.TVText + "\t" + (mwqmSite.t.IsActive ? "1" : "") + "\r\n");
            //                }
            //            }
            //        }
            //    }
        ...
        private void butImportingPatriceMWQMImage_Click(object sender, EventArgs e)
        {
            //// ----------------------------------------------------------------------------------------------
            //// Reading Files
            //// ----------------------------------------------------------------------------------------------

            //DirectoryInfo di = new DirectoryInfo(@"\\Atlantic.int.ec.gc.ca\shares\Branches\EPB\ShellFish\Staff Folders\Patrice Godin\Photos\Classification Site Pictures\");
            ////DirectoryInfo di = new DirectoryInfo(@"E:\Classification Site Pictures\");

            //if (!di.Exists)
            //{
            //    richTextBoxStatus.AppendText("Could not find directory [" + di.FullName + "\r\n");
            //    return;
            //}

            //List<string> DirNameList = new List<string>() { "NB9-19", "NB121-352", "NB411-533", "NB621-753" };

            //List<SS> SSList = new List<SS>();
            //foreach (string dirName in DirNameList)
            //{
            //    DirectoryInfo diFile = new DirectoryInfo(di.FullName + @"\" + dirName + @"\");

            //    lblStatus.Text = diFile.FullName;
            //    lblStatus.Refresh();
            //    Application.DoEvents();

            //    if (!diFile.Exists)
            //    {
            //        richTextBoxStatus.AppendText("Could not find directory [" + diFile.FullName + "\r\n");
            //        return;
            //    }

            //    List<DirectoryInfo> DirInfoList = diFile.GetDirectories().ToList();

            //    foreach (DirectoryInfo diDir in DirInfoList)
            //    {
            //        foreach (FileInfo fi in diDir.GetFiles().Where(c => c.Name.ToLower().EndsWith(".jpg")).ToList())
            //        {
            //            lblStatus.Text = fi.FullName;
            //            lblStatus.Refresh();
            //            Application.DoEvents();

            //            //richTextBoxStatus.AppendText(fi.FullName + "\r\n");

            //            if (fi.Name.Substring(0, 2) == "NB")
            //            {

            //                string Subsector = "";
            //                string TVTextFile = fi.Name;

            //                Subsector = TVTextFile.Substring(0, TVTextFile.IndexOf(" "));

            //                if (Subsector.Length != 12)
            //                {
            //                    if (!(Subsector.Substring(2, 1) == "-" && Subsector.Length == 13))
            //                    {
            //                        richTextBoxStatus.AppendText("Subsector does not have 12 characters [" + fi.FullName + "\r\n");
            //                    }
            //                }

            //                if (Subsector.Substring(2, 1) != "-")
            //                {
            //                    Subsector = Subsector.Substring(0, 2) + "-" + Subsector.Substring(2);
            //                }

            //                //richTextBoxStatus.AppendText(Subsector + "\r\n");

            //                SS ssFound = SSList.Where(c => c.Name == Subsector).FirstOrDefault();
            //                if (ssFound == null)
            //                {
            //                    SSList.Add(new SS() { Name = Subsector });
            //                }
            //                ssFound = SSList.Where(c => c.Name == Subsector).FirstOrDefault();
            //                if (ssFound == null)
            //                {
            //                    richTextBoxStatus.AppendText("Could not Subsector [" + Subsector + "] just added to the list 'SSList'\r\n");
            //                }
            //                string SSSite = "";

            //                if (!fi.Name.ToLower().EndsWith(".jpg"))
            //                {
            //                    richTextBoxStatus.AppendText("File [" + fi.FullName + "] does not end with .JPG\r\n");
            //                }

            //                SSSite = fi.Name.ToLower().Replace(".jpg", "");
            //                SSSite = SSSite.Substring(SSSite.LastIndexOf(" ") + 1).Trim();

            //                SSSite = "0000".Substring(SSSite.Length) + SSSite;
            ...
            //                SSS ssSite = ssFound.SSSiteList.Where(c => c.SiteName == SSSite).FirstOrDefault();
            //                if (ssSite == null)
            //                {
            //                    ssFound.SSSiteList.Add(new SSS() { FileInfoSite = fi, SiteName = SSSite });
            //                }
            //            }
            //            else
            //            {
            //                richTextBoxStatus.AppendText("Image file name does not start with NB [" + fi.FullName + "\r\n");
            //                return;
            //            }
            ...
            //user = new GenericPrincipal(new GenericIdentity("Patrice.Godin@canada.ca", "Forms"), null);

            //if (user == null)
            //{
            //    richTextBoxStatus.AppendText("Could not create user\r\n");
            //}
            ...
            //                           && cl.Language == (int)LanguageEnum.en
            //                           && c.TVType == (int)TVTypeEnum.Subsector
            //                           && cl.TVText.StartsWith(ss.Name + " ")
            //                           select c).FirstOrDefault();

            //        if (tvItemSS == null)
            //        {
            //            richTextBoxStatus.AppendText("Could not find Subsector [" + ss.Name + "] in the DB\r\n");
            //        }

            //        foreach (SSS site in ss.SSSiteList)
            //        {
            //            TVItem tvItemSite = (from c in db.TVItems
            //                                 from cl in db.TVItemLanguages
            //                                 where c.TVItemID == cl.TVItemID
            //                                 && cl.Language == (int)LanguageEnum.en
            //                                 && c.TVType == (int)TVTypeEnum.MWQMSite
            //                                 && cl.TVText == site.SiteName
            //                                 && c.ParentID == tvItemSS.TVItemID
            //                                 select c).FirstOrDefault();

            //            if (tvItemSite == null)
            //            {
            //                richTextBoxStatus.AppendText("Could not find Site [" + site + "] for Subsector [" + ss.Name + "] in the DB\r\n");
            //            }

            //            lblStatus.Text = ss.Name + " -- " + site.SiteName;
            //            lblStatus.Refresh();
            //            Application.DoEvents();

            //            FileInfo fi = new FileInfo(site.FileInfoSite.FullName);
            //            if (!fi.Exists)
            //            {
            //                richTextBoxStatus.AppendText("Could not find file [" + fi.FullName + "]\r\n");
            //            }
            ...
            //            string TVText = ss.Name + " MWQM Site " + site.SiteName.ToUpper() + " for monitoring";

            //            //TVItemService tvItemService = new TVItemService(LanguageEnum.en, user);

            //            //TVItemModel tvItemModelFile = tvItemService.GetChildTVItemModelWithParentIDAndTVTextAndTVTypeDB(tvItemSite.TVItemID, TVText, TVTypeEnum.File);
            //            //if (!string.IsNullOrWhiteSpace(tvItemModelFile.Error))
            //            //{
            //            //    tvItemModelFile = tvItemService.PostAddChildTVItemDB(tvItemSite.TVItemID, TVText, TVTypeEnum.File);
            //            //    if (!string.IsNullOrWhiteSpace(tvItemModelFile.Error))
            //            //    {
            //            //        richTextBoxStatus.AppendText(tvItemModelFile.Error + "\r\n");
            //            //    }
            ...
            //            //tvFileModel.FileType = FileTypeEnum.JPEG;
            //            //tvFileModel.FileSize_kb = (int)(fi.Length / 1024);
            //            //tvFileModel.FileInfo = "On water picture of the monitoring site [" + site.SiteName.ToUpper() + "]";
            //            //tvFileModel.FileCreatedDate_UTC = fi.CreationTimeUtc;
            //            //tvFileModel.FromWater = true;
            //            //tvFileModel.ServerFilePath = @"E:\inetpub\wwwroot\csspwebtools\App_Data\" + tvItemSite.TVItemID.ToString() + @"\";
            //            //tvFileModel.ServerFileName = TVText + ".jpg";
            //            //tvFileModel.FileDescription = "On water picture of the monitoring site [" + site.SiteName.ToUpper() + "]";
            ...
            //            //DirectoryInfo di2 = new DirectoryInfo(tvFileModelRet.ServerFilePath);
            ...
            //            richTextBoxStatus.AppendText(ss.Name + "\t" + site.SiteName + "\r\n");

            //        }
            //        //richTextBoxStatus.AppendText(ss.Name + "\t" + string.Join(",", ss.SSSiteList) + "\r\n");
        ...
        private void button35_Click(object sender, EventArgs e)
        {
            ...
            // ------------------------------------------------------------------------------------------
            // Finding 2 samples under the same run with same type
            // ------------------------------------------------------------------------------------------
            ...
            using (CSSPWebToolsDBEntities db = new CSSPWebToolsDBEntities())
            {
                ...
                foreach (var ss in ssList)
                {
                    lblStatus.Text = ss.cl.TVText;
                    lblStatus.Refresh();
                    Application.DoEvents();

                    var runList = (from c in db.MWQMRuns
                                   from t in db.TVItemLanguages
                                   where c.MWQMRunTVItemID == t.TVItemID
                                   && c.SubsectorTVItemID == ss.c.TVItemID
                                   select new { c, t }).ToList();

                    foreach (var run in runList)
                    {
                        mwqmSampleOld = new MWQMSample();

                        lblStatus.Text = ss.cl.TVText + "\t" + run.c.DateTime_Local;
                        lblStatus.Refresh();
                        Application.DoEvents();

                        List<MWQMSample> sampleList = (from c in db.MWQMSamples
                                                       where c.MWQMRunTVItemID == run.c.MWQMRunTVItemID
                                                       orderby c.MWQMSiteTVItemID, c.SampleDateTime_Local, c.WaterTemp_C
                                                       select c).ToList();

                        List<int> MWQMSampleIDToDelete = new List<int>();
                        foreach (MWQMSample mwqmSample in sampleList)
                        {
                            if (mwqmSampleOld.MWQMSampleID != 0)
                            {
                                ...
                                {
                                    var siteTVText = (from c in db.MWQMSites
                                                      from t in db.TVItemLanguages
                                                      where c.MWQMSiteTVItemID == t.TVItemID
                                                      && c.MWQMSiteTVItemID == mwqmSample.MWQMSiteTVItemID
                                                      select t.TVText).FirstOrDefault();

                                    if (mwqmSampleOld.SampleDateTime_Local.Hour == 0 && mwqmSampleOld.SampleDateTime_Local.Minute == 0 && mwqmSampleOld.WaterTemp_C < 0)
                                    {
                                        MWQMSampleIDToDelete.Add(mwqmSampleOld.MWQMSampleID);
                                        mwqmSample.WaterTemp_C = mwqmSampleOld.WaterTemp_C;
                                        db.MWQMSamples.Remove(mwqmSampleOld);
                                    }

                                    richTextBoxStatus.AppendText(ss.cl.TVText + "\t" + run.c.DateTime_Local + "\t" + run.t.TVText + "\t" + siteTVText + "\r\n");
                                }
                            }
                        ...
                        if (MWQMSampleIDToDelete.Count > 0)
                        {
                            try
                            {
                                db.SaveChanges();
                        ...
                        //TVItemLanguage tvItemLanguageEN = (from c in db.TVItemLanguages
                        //                                   where c.TVItemID == run.c.MWQMRunTVItemID
                        //                                   && c.Language == (int)LanguageEnum.en
                        //                                   select c).FirstOrDefault();

                        //BaseEnumService baseEnumServiceEN = new BaseEnumService(LanguageEnum.en);
                        //string TVTextEN = run.c.DateTime_Local.ToString("yyyy MM dd"); // + " (" + baseEnumServiceEN.GetEnumText_SampleTypeEnum((SampleTypeEnum?)run.c.RunSampleType) + ")";

                        //tvItemLanguageEN.TVText = TVTextEN;

                        //TVItemLanguage tvItemLanguageFR = (from c in db.TVItemLanguages
                        //                                   where c.TVItemID == run.c.MWQMRunTVItemID
                        //                                   && c.Language == (int)LanguageEnum.fr
                        //                                   select c).FirstOrDefault();

                        //BaseEnumService baseEnumServiceFR = new BaseEnumService(LanguageEnum.fr);
                        //string TVTextFR = run.c.DateTime_Local.ToString("yyyy MM dd"); // + " (" + baseEnumServiceFR.GetEnumText_SampleTypeEnum((SampleTypeEnum?)run.c.RunSampleType) + ")";
            ...
            //        var runList = (from c in db.MWQMRuns
            //                       from t in db.TVItemLanguages
            //                       let containRoutine = (from s in db.MWQMSamples
            //                                             where c.MWQMRunTVItemID == s.MWQMRunTVItemID
            ...
            //            richTextBoxStatus.AppendText(ss.cl.TVText + "\t" + run.c.DateTime_Local + "\t" + run.t.TVText + "\r\n");
            ...
            //}
            // ------------------------------------------------------------------------------------------
            // Endfinding All Runs identified as Routine but TVText is not just Date
            // ------------------------------------------------------------------------------------------
            ...
            //    int count = 0;
            //    int TotalCount = mwqmRunList.Count;

            //    foreach (MWQMRun mwqmRun in mwqmRunList)
            //    {
            //        count += 1;
            //        lblStatus.Text = mwqmRun.SubsectorTVItemID + " --- " + mwqmRun.DateTime_Local + " --- " + count.ToString() + "/" + TotalCount.ToString();
            //        lblStatus.Refresh();
            //        Application.DoEvents();

            //        if (mwqmRun.RunSampleType != (int)SampleTypeEnum.Routine)
            //        {
            //            TVItemLanguage tvItemLanguageEN = (from c in db.TVItemLanguages
            //                                               where c.TVItemID == mwqmRun.MWQMRunTVItemID
            //                                               && c.Language == (int)LanguageEnum.en
            //                                               select c).FirstOrDefault();

            //            BaseEnumService baseEnumServiceEN = new BaseEnumService(LanguageEnum.en);
            //            string TVTextEN = mwqmRun.DateTime_Local.ToString("yyyy MM dd") + " (" + baseEnumServiceEN.GetEnumText_SampleTypeEnum((SampleTypeEnum?)mwqmRun.RunSampleType) + ")";
            ...
            //            BaseEnumService baseEnumServiceFR = new BaseEnumService(LanguageEnum.fr);
            //            string TVTextFR = mwqmRun.DateTime_Local.ToString("yyyy MM dd") + " (" + baseEnumServiceFR.GetEnumText_SampleTypeEnum((SampleTypeEnum?)mwqmRun.RunSampleType) + ")";
            ...
            // -----------------------------------------------------------------------------------------
            // End of Filling TVText with appropriate info when run in not routine
            // -----------------------------------------------------------------------------------------
        ...
        private void button36_Click(object sender, EventArgs e)
        {
            ...
            //    TVItemModel tvItemModelBC = tvItemService.GetTVItemModelWithTVItemIDDB(11); // BC
            //    if (!string.IsNullOrWhiteSpace(tvItemModelBC.Error))
            //    {
            //        int seljif = 34;
            //    }

            //    List<MWQMRun> mwqmRunList = (from c in db.TVItems
            //                                 from r in db.MWQMRuns
            //                                 let exist = (from b in db.MWQMSamples
            //                                              where b.MWQMRunTVItemID == c.TVItemID
            //                                              select b).Any()
            //                                 where c.TVItemID == r.MWQMRunTVItemID
            //                                 && c.TVPath.StartsWith(tvItemModelBC.TVPath + "p")
            //                                 && c.TVType == (int)TVTypeEnum.MWQMRun
            //                                 && !exist
            //                                 select r).ToList();
            ...
            //    foreach (MWQMRun mwqmRun in mwqmRunList)
            //    {
            //        mwqmRunToDeleteList.Add(mwqmRun);
            //    }

            //    int count = 0;
            //    foreach (MWQMRun mwqmRunToDelete in mwqmRunToDeleteList)
            //    {
            //        count += 1;
            //        lblStatus.Text = count.ToString() + " ----- " + mwqmRunToDelete.SubsectorTVItemID + " --- " + mwqmRunToDelete.MWQMRunTVItemID;
            //        lblStatus.Refresh();
            //        Application.DoEvents();

            //        MWQMRunModel mwqmRunModel = mwqmRunService.PostDeleteMWQMRunTVItemIDDB(mwqmRunToDelete.MWQMRunTVItemID);
        ...
        private void button37_Click(object sender, EventArgs e)
        {
            ...
            //string FileName = @"C:\CSSP Latest Code old\DataTool\ImportByFunction\Data_inputs\Copy of PEI two runs on same day-Routine vs CMP-Lauren.xlsx";
            ...
            //    else
            //    {
            //        RunTVText = reader.GetValue(1).ToString().Trim();
            //    }
            ...
            //    else
            //    {
            //        MWQMSite = reader.GetValue(2).ToString().Trim();
            //    }

            //    MWQMSite = "0000".Substring(MWQMSite.Length) + MWQMSite;
            ...
            //    else
            //    {
            //        Run2 = reader.GetValue(7).ToString().Trim();
            //    }
            //    lblStatus.Text = Subsector + "\t" + RunTVText + "\t" + MWQMSite + "\t" + Time + "\t" + Run2;
            //    lblStatus.Refresh();
            //    Application.DoEvents();
            ...
            //        if (Run2 == "1")
            //        {
            //            TVItem tvItemSS = (from c in dd.TVItems
            //                               from cl in dd.TVItemLanguages
            //                               where c.TVItemID == cl.TVItemID
            //                               && cl.Language == (int)LanguageEnum.en
            ...
            //            TVItem tvItemRun = (from c in dd.TVItems
            //                                from cl in dd.TVItemLanguages
            //                                where c.TVItemID == cl.TVItemID
            //                                && cl.Language == (int)LanguageEnum.en
            //                                && cl.TVText == RunTVText
            //                                && c.TVType == (int)TVTypeEnum.MWQMRun
            //                                && c.TVPath.StartsWith(tvItemSS.TVPath + "p")
            //                                select c).FirstOrDefault();
            ...
            //            TVItem tvItemSite = (from c in dd.TVItems
            //                                 from cl in dd.TVItemLanguages
            //                                 where c.TVItemID == cl.TVItemID
            //                                 && cl.Language == (int)LanguageEnum.en
            //                                 && c.TVPath.StartsWith(tvItemSS.TVPath + "p")
            ...
            //            MWQMSample mwqmSample = (from c in dd.MWQMSamples
            //                                     where c.MWQMSiteTVItemID == tvItemSite.TVItemID
            //                                     && c.MWQMRunTVItemID == tvItemRun.TVItemID
            //                                     && c.SampleDateTime_Local.Hour == Time.Hour
            //                                     && c.SampleDateTime_Local.Minute == Time.Minute
            //                                     select c).FirstOrDefault();
            ...
            //                    mwqmSample = (from c in dd.MWQMSamples
            //                                  where c.MWQMSiteTVItemID == tvItemSite.TVItemID
            //                                  && c.MWQMRunTVItemID == tvItemRun.TVItemID
            //                                  && c.SampleDateTime_Local.Hour == Time.Hour
            //                                  && c.SampleDateTime_Local.Minute == Time.Minute
            ...
            //            TVItemModel tvItemModel = tvItemService.GetTVItemModelWithTVItemIDDB(tvItemRun.TVItemID);
            ...
            //            TVItemModel tvItemModelExist = tvItemService.GetChildTVItemModelWithParentIDAndTVTextAndTVTypeDB(tvItemSS.TVItemID, tvItemModel.TVText + " (2)", TVTypeEnum.MWQMRun);
            //            if (!string.IsNullOrWhiteSpace(tvItemModelExist.Error))
            //            {
            //                tvItemModelExist = tvItemService.PostAddChildTVItemDB(tvItemSS.TVItemID, tvItemModel.TVText + " (2)", TVTypeEnum.MWQMRun);
            //                if (!string.IsNullOrWhiteSpace(tvItemModelExist.Error))
            //                {
            //                    int sleifj = 34;
            //                    return;
            ...
            //            MWQMRunModel mwqmRunModelNew = mwqmRunService.GetMWQMRunModelWithMWQMRunTVItemIDDB(tvItemRun.TVItemID);
            //            if (!string.IsNullOrWhiteSpace(mwqmRunModelNew.Error))
            //            {
            //                int sleifj = 34;
            //                return;
            //            }

            //            mwqmRunModelNew.MWQMRunID = 0;
            //            mwqmRunModelNew.MWQMRunTVItemID = tvItemModelExist.TVItemID;
            //            mwqmRunModelNew.RunNumber = 2;
            ...
            //            {
            //                mwqmRunModelExist = mwqmRunService.PostAddMWQMRunDB(mwqmRunModelNew);
            //                if (!string.IsNullOrWhiteSpace(mwqmRunModelNew.Error))
            //                {
            //                    int sleifj = 34;
            //                    return;
            ...
            //            MWQMSampleModel mwqmSampleModelNew = mwqmSampleService.GetMWQMSampleModelWithMWQMSampleIDDB(mwqmSample.MWQMSampleID);
            //            if (!string.IsNullOrWhiteSpace(mwqmSampleModelNew.Error))
            //            {
            //                int sleifj = 34;
            //                return;
            //            }

            //            int mwqmSampleIDToDelete = mwqmSampleModelNew.MWQMSampleID;

            //            mwqmSampleModelNew.MWQMSampleID = 0;
            //            mwqmSampleModelNew.MWQMRunTVItemID = mwqmRunModelExist.MWQMRunTVItemID;

            //            MWQMSampleModel mwqmSampleModelExist = mwqmSampleService.GetMWQMSampleModelExistDB(mwqmSampleModelNew);
            //            if (!string.IsNullOrWhiteSpace(mwqmSampleModelExist.Error))
            //            {
            //                mwqmSampleModelExist = mwqmSampleService.PostAddMWQMSampleDB(mwqmSampleModelNew);
            //                if (!string.IsNullOrWhiteSpace(mwqmSampleModelExist.Error))
            //                {
            //                    int sleifj = 34;
            //                    return;
            ...
            //            MWQMSampleModel mwqmSampleModelToDelete = mwqmSampleService.PostDeleteMWQMSampleDB(mwqmSampleIDToDelete);
            //            if (!string.IsNullOrWhiteSpace(mwqmSampleModelToDelete.Error))
            //            {
            //                int sleifj = 34;
            //                return;
            //            }
        ...
        {
            //using (pccsmEntities db2 = new pccsmEntities())
            //{

            //    int count = (from c in db2.db_mesure
            //                 from t in db2.db_tournee
            //                 from g in db2.geo_stations_p
            //                 where c.id_tournee == t.ID_Tournee
            //                 && c.id_geo_station_p == g.id_geo_station_p
            //                 && c.diffusable == true
            //                 && t.date_echantillonnage.Value.Year < 2018
            //                 select c).Count();
            ...
            List<TVItemModel> tvitemModelSSList = tvItemService.GetChildrenTVItemModelListWithTVItemIDAndTVTypeDB(tvItemModelQC.TVItemID, TVTypeEnum.Subsector);

            List<string> QCSubsectorList = new List<string>();
            using (pccsmEntities db = new pccsmEntities())
            {
                QCSubsectorList = (from g in db.geo_stations_p
                                   where g.secteur != null
                                   select g.secteur).Distinct().ToList();
            }

            List<QCSubsectorAssociation> SSAssocList = new List<QCSubsectorAssociation>();
            using (TempDataToolDBEntities td = new TempDataToolDBEntities())
            {
                SSAssocList = (from c in td.QCSubsectorAssociations
                               orderby c.QCSectorText
                               select c).ToList();
            }
            ...
            foreach (TVItemModel tvItemModelSS in tvitemModelSSList)
            {
                ...
                using (CSSPWebToolsDBEntities db = new CSSPWebToolsDBEntities())
                {
                    ...
                    List<QCSubsectorAssociation> qcSSAList = (from c in SSAssocList
                                                              where c.SubsectorText.StartsWith(TVText)
                                                              select c).ToList();

                    foreach (QCSubsectorAssociation qcss in qcSSAList)
                    {
                        string Pre = "";
                        if (qcss.QCSectorText != qcss.SubsectorText)
                        {
                            if (qcss.QCSectorText.Length > qcss.SubsectorText.Length)
                            {
                                sb.AppendLine(tvItemModelSS.TVText + "\t" + qcss.QCSectorText + "\t");

                                Pre = qcss.QCSectorText.Substring(qcss.SubsectorText.Length);
                                if (Pre.StartsWith("."))
                                {
                                    Pre = Pre.Substring(1);
                                }
                        ...
                        using (pccsmEntities db2 = new pccsmEntities())
                        {
                            ...
                            var sampleList = (from c in db2.db_mesure
                                              from t in db2.db_tournee
                                              from g in db2.geo_stations_p
                                              where c.id_tournee == t.ID_Tournee
                                              && c.id_geo_station_p == g.id_geo_station_p
                                              && g.secteur == qcss.QCSectorText
                                              && c.diffusable == true
                                              orderby g.station, t.date_echantillonnage
                                              select new { station = "" + Pre + "0000".Substring(0, "0000".Length - g.station.ToString().Length) + g.station.ToString(), date = t.date_echantillonnage, c.cf, c.prof, c.temp, c.sal, c.ph, c.diffusable }).ToList();

                            foreach (var mwqmSample in mwqmSampleList)
                            {
                                var sample = (from c in sampleList
                                              where c.station == mwqmSample.tl.TVText
                                              && c.date.Value.Year == mwqmSample.s.SampleDateTime_Local.Year
                                              && c.date.Value.Month == mwqmSample.s.SampleDateTime_Local.Month
                                              && c.date.Value.Day == mwqmSample.s.SampleDateTime_Local.Day
                                              select c).FirstOrDefault();
        ...
        private void button43_Click(object sender, EventArgs e)
        {
            ...
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("Subsector\tSite\tClassification");
            using (CSSPWebToolsDBEntities db2 = new CSSPWebToolsDBEntities())
            {
                ...
                if (!string.IsNullOrEmpty(tvItemModelProv.Error))
                {
                    int slefij = 34;
                }
                ...
                foreach (TVItemModel tvItemModelSS in tvItemModelSSList)
                {
                    string TVTextSS = tvItemModelSS.TVText;
                    ...
                    {
                        sb.AppendLine($"{ TVTextSS }\t{ mwqmSiteModel.MWQMSiteTVText }\t{ mwqmSiteModel.MWQMSiteLatestClassification }");
                    }
                }
...
//                    List<PolSourceObservationIssueModel> polSourceObservationIssueModelList = polSourceObservationIssueService.GetPolSourceObservationIssueModelListWithPolSourceObservationIDDB(polSourceObservationModel.PolSourceSiteID);
